...
* [Basics of using IDC data programmatically](https://github.com/ImagingDataCommons/IDC-Tutorials/blob/master/notebooks/getting_started/part2_searching_basics.ipynb): learn how to use `idc-index` python package to programmatically search and download IDC data, visualize images and annotations (including interactive 3D rendering of an image with its segmentation overlay directly in the notebook using [ipyniivue](https://github.com/niivue/ipyniivue)), build cohorts and checking acknowledgments and licenses for the data included in your cohort.
...
* [Visualizing IDC data in 3D with trame-slicer](https://github.com/ImagingDataCommons/IDC-Tutorials/blob/master/notebooks/advanced_topics/trame_slicer_visualization.ipynb): view IDC images and segmentations interactively in 3D inside a Colab cell using [trame-slicer](https://github.com/KitwareMedical/trame-slicer), which brings the 3D Slicer rendering engine (VTK-grade volume rendering, multi-planar reformat, segmentation overlay) to the browser. For a lighter-weight WebGL viewer embedded directly in the notebook, see the ipyniivue section of the [Getting started Part 2](https://github.com/ImagingDataCommons/IDC-Tutorials/blob/master/notebooks/getting_started/part2_searching_basics.ipynb) tutorial.
...
* [Running the full 3D Slicer desktop in Colab with IDC data](https://github.com/ImagingDataCommons/IDC-Tutorials/blob/master/notebooks/labs/image_visualization_with_slicer_desktop.ipynb) (⚠️ **experimental, not actively supported**): launch the complete [3D Slicer](https://www.slicer.org) desktop application headlessly and stream its live GUI into a Colab cell using the experimental [desktopia](https://github.com/pieper/desktopia) project, loading an IDC DICOM image and DICOM SEG natively. This is a developer/community proof-of-concept that depends on fast-moving, unversioned components and may break without notice — for a robust, supported in-notebook viewer use the ipyniivue section of [Getting started Part 2](https://github.com/ImagingDataCommons/IDC-Tutorials/blob/master/notebooks/getting_started/part2_searching_basics.ipynb).
